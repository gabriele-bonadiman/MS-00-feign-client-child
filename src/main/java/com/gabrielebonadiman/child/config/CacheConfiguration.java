...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("child");
        ...
        config.getMapConfigs().put("com.gabrielebonadiman.child.domain.*", initializeDomainMapConfig(jHipsterProperties));
